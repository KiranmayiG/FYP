...
tap_1.test('windows with wrapper in root', function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                expectedCmd = path.join(subWithWrapper, 'gradlew.bat');
...
tap_1.test('windows with wrapper', function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var _a, cmd, expectedCmd;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 3:
                _a = _b.sent();
                cmd = subProcess.execute.getCall(0).args[0];
                expectedCmd = path.join(rootWithWrapper, 'gradlew.bat');
                t.same(cmd, expectedCmd, 'invokes wrapper bat');
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
tap_1.test('windows without wrapper', function (t) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var _a, cmd;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
...
//# sourceMappingURL=windows.test.js.map