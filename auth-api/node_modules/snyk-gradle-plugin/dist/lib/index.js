        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!options.multiDepRoots) return [3 /*break*/, 2];
                    if (subProject) {
                    ...
                    return [4 /*yield*/, getAllDepsAllProjects(root, targetFile, options)];
                case 1: return [2 /*return*/, (_a.depRoots = _c.sent(),
                        _a)];
                case 2:
                    _b = {
                        plugin: plugin
                    };
                    return [4 /*yield*/, getAllDepsOneProject(root, targetFile, options, subProject)];
                case 3: return [2 /*return*/, (_b.package = _c.sent(),
                        _b)];
            }
        });
    });
...
function getAllDepsOneProject(root, targetFile, options, subProject) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var packageName, allProjectDeps, depDict, packageVersion;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    packageName = path.basename(root);
                    return [4 /*yield*/, getAllDeps(root, targetFile, options)];
                case 1:
                    allProjectDeps = _a.sent();
                    depDict = {};
                    if (subProject) {
...
function getAllDepsAllProjects(root, targetFile, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var allProjectDeps, basePackageName, packageVersion;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getAllDeps(root, targetFile, options)];
                case 1:
                    allProjectDeps = _a.sent();
                    basePackageName = path.basename(root);
                    packageVersion = '0.0.0';
                    return [2 /*return*/, Object.keys(allProjectDeps.projects).map(function (proj) {
                            var packageName = proj === allProjectDeps.defaultProject ? basePackageName : basePackageName + '/' + proj;
                            return {
...
function getAllDeps(root, targetFile, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var args, tmpInitGradle, initGradlePath, error_1, command, stdoutText, error_2;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 6:
                    ...
                    return [2 /*return*/, extractJsonFromScriptOutput(stdoutText)];
                case 7:
                    error_2 = _a.sent();
